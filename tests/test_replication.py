...
def test_t_star_largest_tied_horizon():
    # Increasing CEX A price makes the final horizon the maximum in this fixture.
    points=tuple(MarkoutPoint(h,Decimal("100")+Decimal(i),Decimal("1")) for i,h in enumerate(HORIZONS))
